...
export default function generateAuditReportPDF(data, options) {
    ...
    // === REPORT TYPE: OUTLET NON-COMPLIANCE SUMMARY ===
        ...
        const conclusionPoints = [
            `Focus on improving ${mostCompliant.outletName} (currently at ${mostCompliant.complianceRate}%)`,
            `Maintain high performance in ${leastCompliant.outletName} (currently at ${leastCompliant.complianceRate}%)`,
