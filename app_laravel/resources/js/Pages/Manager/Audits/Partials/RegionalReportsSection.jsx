                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <button
                                            className={`rounded-md px-4 py-2 text-xs font-medium ${reportFileStates[report.id]?.exists ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-200 text-gray-400 cursor-not-allowed'}`}
