...
export default function ReviewSubmissionsSection({ onReviewForm }) {
    ...
    return (
        <div className="px-6 py-6">
            <div className="mb-4 flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-800">Outlet Submissions for Your Review</h3>
                <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-500">{submittedForms.length} forms found</span>
                    <AdminPrimaryButton
