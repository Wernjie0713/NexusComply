...
import RegionalAuditProgressSection from './Partials/RegionalAuditProgressSection';
            ...
            <div className="py-0">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-0">
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        {activeTab === 'progress' && <RegionalAuditProgressSection onReviewForm={handleFormReview} />}
                        {activeTab === 'submissions' && <ReviewSubmissionsSection onReviewForm={handleFormReview} />}
