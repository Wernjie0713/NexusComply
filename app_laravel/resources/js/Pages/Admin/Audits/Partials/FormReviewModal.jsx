        ...
        <div className="max-h-[90vh] overflow-y-auto p-4 md:p-6">
            <div className="mb-6 flex items-center justify-between">
                <h2 className="text-xl font-semibold text-gray-800">
                    Review Submitted Form: {form.name}
                </h2>
            ...
            <div className="flex flex-wrap justify-end gap-3">
                ...
                <button
                    type="button"
                    onClick={onClose}
                    className={`rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 ${getActionButtonClass('archive')}`}
                >
                    Archive
                </button>
                <button
                ...
                <Link
                    href={route('audits.share-form', form.id)}
